...
public class MainActivity extends AppCompatActivity {
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                ...
                for (org.json.JSONObject row : servers) {
                    ...
                    String rowBaseDomain = row.optString("base_domain", "");
                    if (!rowBaseDomain.isEmpty()) s.setBaseDomain(rowBaseDomain);
    ...
    private static String lastShownPendingLink;

    /** Prueft bei jedem App-Start/resume auf ausstehende Lobby-Link-Anfragen. */
    private void checkPendingLinkOnMain(String baseUrl, String apiKey) {
        ...
        new Thread(() -> {
            ...
            if (mcName != null && !mcName.equals(lastShownPendingLink)) {
                final String mc = mcName;
                lastShownPendingLink = mc;
                runOnUiThread(() -> {
                    if (isFinishing() || isDestroyed()) return;
