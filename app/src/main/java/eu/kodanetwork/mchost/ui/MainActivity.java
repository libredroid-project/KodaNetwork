...
public class MainActivity extends AppCompatActivity {
    ...
    private java.util.List<org.json.JSONObject> fetchCloudServerCandidates(String baseUrl, String apiKey) {
        ...
        String[][] calls = {
            {"/rpc/rpc_get_my_servers", "{\"p_app_uuid\":\"" + appUuid + "\",\"p_device_token\":\"" + deviceToken + "\"}"},
            {"/rpc/rpc_get_servers_by_auth_id", "{\"p_app_uuid\":\"" + appUuid + "\",\"p_device_token\":\"" + deviceToken + "\"}"},
        };
    ...
    private void callAdoptServers(String baseUrl, String apiKey) {
        try {
            ...
            java.net.URL url = new java.net.URL(baseUrl + "/rpc/rpc_adopt_servers");
            java.net.HttpURLConnection c = (java.net.HttpURLConnection) url.openConnection();
            c.setRequestMethod("POST");
            c.setRequestProperty("Content-Type", "application/json");
            c.setRequestProperty("apikey", apiKey);
